...
<br>
Google Scholar Citation: **327**; h-index=**8**; i10-index=**6** (2026.09)
...
<div class="journal-cover-gallery" aria-label="Selected journals">
  ...
  <figure class="journal-cover">
    <img src="images/journals/marine-structures-cover.jpg" >
    <figcaption>Marine Structures</figcaption>
  </figure>
  <figure class="journal-cover">
...
-- Coupled hydro-structural analysis of reinforced heave plates under forced oscillations

-- Directional stress-wave transmission and impact-load redistribution in a bi-axial symmetrical flower-core structure

-- Hydrodynamic characteristics of double heave plates: A combined experimental and numerical investigation
